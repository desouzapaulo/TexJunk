...
\begin{equation}
	\mathbf{E} = \frac{1}{2}\left(\mathbf{F}\mathbf{F}^T-\mathbf{1}\right)=\frac{1}{2} \left( \nabla_0 \mathbf{u}^T + \nabla_0 \mathbf{u} + \nabla_0 \mathbf{u}^T \nabla_0 \mathbf{u} \right),
\end{equation}
