...
\preambulo{Monografia apresentada ao Departamento de Engenharia Mecânica da Escola de Engenharia da Universidade Federal do Rio Grande do Sul, como parte dos requisitos para obtenção do diploma de Engenheiro Mecânico.}
% ---

\newcommand{\coordenador}{Cirilo Seppi Bresolin} % COORDENADOR DO CURSO
\newcommand{\areaconcentracao}{Mecânica dos Sólidos} % AREA DE CONCENTRAÇÃO (Energia e Fenômenos de Transporte/Processos de Fabricação/Mecânica dos Sólidos)
...
\begin{document}
	...
	\include{TCC/Paginas/Preambulo/Capa}
	\pretextual{}
	\includepdf[pages=-]{TCC/Paginas/Preambulo/doc.pdf} %FOLHA DE ROSTO ->https://sabi.ufrgs.br/servicos/publicoBC/ficha.php
	
	\include{TCC/Paginas/Preambulo/folhaAprovacao}  % folha de aprovação
	\include{TCC/Paginas/Preambulo/Agradecimentos} % agradecimentos, epígrafe ...
	\include{TCC/Paginas/Preambulo/Resumo} %resumo e abstract
	...
	\parindent=1em
	\justifying
	\input{TCC/Paginas/Introdução}
	{\let\clearpage\relax  %REMOVE QUEBRA DE PÁGINA ENTRE CAPÍTULOS
		
		\input{TCC/Paginas/FundamentacaoTeorica}
		
		\input{TCC/Paginas/Metodologia}
		
		\input{TCC/Paginas/Resultados}
		
		\input{TCC/Paginas/Conclusão}
		
		% \renewcommand\bibname{REFERENCIAS BIBLIOGRÁFICAS}
		% \bibliography{references} %IMPRIME REFERENCIAS
		\printbibliography
		
		\input{TCC/Paginas/Apendice} %IMPRIME APENDICE
